...
export class ListaCitasComponent implements OnInit {
  ...
  agregar_URL(nombre: any, id: any, precio: any, fecha: any) {
    this.url ='https://heartlabs1.azurewebsites.net/'+id+'/'+nombre+'/'+precio+'/'+fecha+'/'+this.usuarioActual.name+'/'+this.usuarioActual.lastName;
    this.value = this.url;
  }

  abriracceso(nombre: any, id: any, precio: any, fecha: any) {
    window.open('https://heartlabs1.azurewebsites.net/'+id+'/'+nombre+'/'+precio+'/'+fecha+'/'+this.usuarioActual.name+'/'+this.usuarioActual.lastName,'_blank');
  }
}
